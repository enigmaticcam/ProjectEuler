...
namespace Euler_Win {
    public partial class frmMain : Form {
        ...
        private void GetProblems() {
            ...
            _problems.Add(new Problem215());
            _problems.Add(new Problem221());
            _problems.Add(new Problem223());
            _problems.Add(new Problem224());
        ...
        private void cmdDefault_Click(object sender, EventArgs e) {
            Go(new Euler_Logic.Problems.AdventOfCode.Y2020.Problem17());
        }
    }
}
